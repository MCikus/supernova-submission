...
import { all, update, accept, reject } from '@/domain/updateTopic/services/proposalApiClient.js'
...
export const useProposalsStore = defineStore('useProposalsStore', {
  ...
  actions: {
    ...
    async acceptProposal(proposalId){
      const proposalIndex = this.incoming.findIndex(proposal => proposal.id === proposalId)
