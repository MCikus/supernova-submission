...
export const useProposeChangesDialogStore = defineStore('useProposeChangesDialogStore', {
  ...
  actions: {
    ...
    incrementStep() {
      ...
      const eachStepHasAValue = stepsWithoutSubmitStep.findIndex(step => step.value === '') === -1
      ...
      if(this.currentStepIndex + 1 < this.steps.length && this.steps[this.currentStepIndex].value !== ''){
