<template>
    <textarea
        ...
        ref="inputEl"
        class="focus:outline-none focus-visible:outline-none h-full w-full resize-none border-0 bg-transparent p-0 focus:ring-0"
    ...
    <input
        v-if="editing && !multiline"
        ref="inputEl"
        class="focus:outline-none focus-visible:outline-none m-0 w-full border-0 bg-transparent p-0 focus:ring-0"
        :class="[$attrs.class, componentName]"
        type="text"
        :value="computedValue"
        :placeholder="computedPlaceholder"
    ...
    <span
        ...
        class="w-fit inline-block text-[#5F75D7] underline"
        :class="$attrs.class"
        @click="toggle"
    >
        Edit
