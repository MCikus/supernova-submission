<template>
    <div class="border-box p-2">
        <div
            ...
            ref="card"
            tabindex="0"
            class="focus:outline-none flex flex-col overflow-hidden rounded-lg transition-size focus:ring-4 focus:ring-opacity-30 focus:ring-offset-0"
            :class="[computedCardColor, computedCardSize]"
        >
            <div
                class="focus:outline-none flex h-[11rem] min-h-[11rem] w-full items-start justify-start px-3 py-4"
                :class="[$options.name]"
            >
            ...
            >
                ...
                >
                    <div
                        class="flex flex-grow flex-col px-3 xl:overflow-y-scroll xl:pr-4"
                    >
