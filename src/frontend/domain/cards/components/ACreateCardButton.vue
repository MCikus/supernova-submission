<template>
  <div class="border-box p-2">
    <div
      :id="componentData.id"
      tabindex="0"
      class="group flex cursor-pointer items-center justify-center rounded-lg focus:outline-none focus:ring-4 focus:ring-opacity-30 focus:ring-offset-0"
      ...
      <div class="flex items-center justify-center">
        ...
        >
          <PPlusIcon
            ...
            :css-classes="['h-14', 'w-14', '-m-3.5', 'md:h-10', 'md:w-10', 'md:-m-2.5']"
          />
        </span>
      </div>
    </div>
