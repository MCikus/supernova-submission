<template>
    <Menu as="div" class="relative inline-block text-left" :class="[$options.name]">
        <div>
            <MenuButton
                class="focus:outline-none m-1 flex items-center rounded-sm p-1 text-primary hover:text-primary-focus focus:ring-2 focus:ring-primary-focus focus:ring-offset-2"
            >
        ...
        >
            <MenuItems
                class="focus:outline-none absolute right-0 z-10 mt-2 w-56 origin-top-right rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5"
            >
                <div class="py-1">
                    <MenuItem
