    ...
    <div class="flex w-full flex-row rounded-md bg-gray-200" :class="componentName">
        <div v-if="showUrlInput" class="flex grow overflow-hidden">
            <input
                ref="inputRef"
                v-model="value"
                class="focus:outline-none mx-auto w-full truncate rounded-md bg-gray-200 p-2 leading-8"
        ...
        >
            <div
                ...
                class="basis-32 flex flex-shrink-0 flex-grow-0 rounded-l-md bg-gray-200"
            >
                <img
