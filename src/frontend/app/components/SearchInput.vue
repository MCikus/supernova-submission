    ...
    <div v-if="searchInputVisible" class="lg:max-w-xs w-full max-w-lg">
      ...
      <div class="relative">
        <div class="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3">
          <SearchIcon class="text-base-2000 h-5 w-5" aria-hidden="true" />
        </div>
        <input
          id="search"
          ref="inputFieldRef"
          ...
          name="search"
          class="sm:text-sm text-base-2000 placeholder-base-2000 block w-full rounded-md border border-transparent bg-white py-1.5 pl-10 pr-3 leading-5 focus:border-white focus:text-base-content focus:outline-none focus:ring-gray-300"
          placeholder="Search"
          type="search"
