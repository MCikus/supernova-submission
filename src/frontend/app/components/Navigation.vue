        ...
        <ProfileMenu :showAvatar="true">
          <template #middle>
            <div class="mt-[10px] flex flex-col items-center px-3">
              <div class="mb-5 flex min-h-[114px] items-center justify-center">
              ...
              <button
                class="mt-5 mb-3 flex items-center gap-3 rounded-lg bg-indigo-50 px-5 py-3 text-sm font-normal text-gray-700"
              >
                <span>
                  <svg
                    width="14"
