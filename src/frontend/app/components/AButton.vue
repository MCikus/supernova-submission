<template>
    <component
        :is="computedTag"
        v-if="!isUnstyled"
        class="focus:outline-none inline-flex items-center justify-center rounded-angularness border border-transparent bg-primary text-primary-content hover:bg-primary-focus focus:ring-2 focus:ring-primary-focus focus:ring-offset-2"
